...
def train_model(model, dataloaders, criterion, optimizer, num_epochs=5, weights_name='weight_save', is_inception=False):
    '''
...
best_model, val_acc_history, loss_acc_history = train_model(
    alexnet_sequential, dataloaders, criterion, optimizer, 10, 'alex_sequential_lr_0.001_bestsofar')
